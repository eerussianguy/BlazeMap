...
public class PacketChunkMDUpdate {
    ...
    public PacketChunkMDUpdate(ResourceKey<Level> dimension, ChunkPos pos, List<MasterDatum> data, String source) {
    ...
    static PacketChunkMDUpdate decode(FriendlyByteBuf buffer) {
        ...
        return new PacketChunkMDUpdate(dimension, pos, data, source);
    }
}
